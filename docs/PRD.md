...
이는 3시간 30분에 맞춘 작업 순서안이며 일정 보장이 아니다. 시간이 부족하면 P1을 제외하고 P0 대표 경로·교사 게이트·실패 경로를 우선한다. 기술 스택·AI 공급자는 아직 미정이며 제품 요구사항과 분리한다.
...
| 결정 필요 | 기본 처리 | 확정 시점 |
| --- | --- | --- |
| 기술 스택·호스팅·AI 모델 | 문서에서 미지정; 서버 AI 경유·구조화 출력 충족 | 구현 시작 |
