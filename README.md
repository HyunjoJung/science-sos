...
2026-09-20 문서 갱신 기준 main은 `a31aa5b`, 새 기능의 기준은 `feature/learning-mcp-resources`의 `7bac902`입니다. 기능 브랜치의 코드나 테스트 통과를 운영 서비스·실제 모델 연결 완료로 간주하지 않습니다. 이전 DB 기록과 체험 데이터를 삭제하거나 새 구조로 소급 채점하지 않습니다.
